...
{
    const auto Root = std::filesystem::temp_directory_path() / "beez_config_paths_xdg_test";
...
{
    const auto HomeRoot = std::filesystem::temp_directory_path() / "beez_config_paths_home_test";
