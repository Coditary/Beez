...
[[nodiscard]] DataFormat resolveFormat(const std::filesystem::path& path, const sol::object& options);
[[nodiscard]] DataFormat resolveFormat(const sol::object& options);

[[nodiscard]] sol::table deserializeString(sol::state& luaState,
...
[[nodiscard]] sol::table deserializeFile(sol::state& luaState,
