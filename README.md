...
- **Lua DSL** (`build.lua`): steps, tasks, workflows, `order()`, per-step config, in-step **workers** (`ctx:spawn` / `ctx:wait`), **network** (`beez.net.*`), **archives** (`beez.archive.*`)
...
| Developer docs | [`docs/`](docs/) (incl. [`worker-api.md`](docs/worker-api.md), [`net-api.md`](docs/net-api.md), [`archive-api.md`](docs/archive-api.md)) |
