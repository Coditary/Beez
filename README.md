...
- **Lua DSL** (`build.lua`): steps, tasks, workflows, `order()`, per-step config, in-step **workers** (`ctx:spawn` / `ctx:wait`), **network** API (`beez.net.*`)
...
| Developer docs | [`docs/`](docs/) (incl. [`worker-api.md`](docs/worker-api.md), [`net-api.md`](docs/net-api.md)) |
