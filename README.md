...
- **Lua DSL** (`build.lua`): steps, tasks, workflows, `order()`, per-step config, in-step **workers** (`ctx:spawn` / `ctx:wait`)
...
| Developer docs | [`docs/`](docs/) (incl. [`docs/worker-api.md`](docs/worker-api.md)) |
