...
local runtime_plugin_root = layout.join_path(paths.version_root, "share/reqpack/plugins/beez")
for _, relative_path in ipairs({"metadata.json", "reqpack.lua", "run.lua", "default-plugin-repositories.json", "scripts/install.lua", "scripts/remove.lua"}) do
